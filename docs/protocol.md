        # Metaverse Robust Ma: Protocol Registration

        **Author:** Mahmood Ahmad, Royal Free Hospital, London, UK
        **ORCID:** 0009-0003-7781-4478
        **Registration Date:** 2026-03-28
        **Repository:** https://github.com/mahmood726-cyber/metaverse-robust-ma.git

        ## Objective

        MetaVerse Robust MA implements robust meta-analytic methods within a multiverse framework, exploring the stability of conclusions across analytical perturbations.
        ...
        - Code: https://github.com/mahmood726-cyber/metaverse-robust-ma.git
        - Dashboard: https://mahmood726-cyber.github.io/metaverse-robust-ma/
